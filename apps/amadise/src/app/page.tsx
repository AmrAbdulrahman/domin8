      ...
      <section className="d8-hero">
        <Container>
          <div className="d8-hero__grid">
            ...
            <div className="d8-hero__media">
              <img
                src="/products/handheld-sewing-machine.webp"
                alt="Domin8 handheld sewing machine, sold under the Amadise brand"
                className="d8-hero__media-image"
              />
            </div>
          </div>
        </Container>
